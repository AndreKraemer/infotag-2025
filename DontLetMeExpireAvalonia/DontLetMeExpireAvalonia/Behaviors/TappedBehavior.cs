...
namespace DontLetMeExpireAvalonia.Behaviors
{
    public class TappedBehavior : AvaloniaObject
    {
        ...
        public static readonly AttachedProperty<ICommand> CommandProperty = AvaloniaProperty.RegisterAttached<TappedBehavior, Interactive, ICommand>(
        ...
        public static readonly AttachedProperty<object> CommandParameterProperty = AvaloniaProperty.RegisterAttached<TappedBehavior, Interactive, object>(
